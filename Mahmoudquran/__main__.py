...
from Mahmoudquran.Modules import ALL_MODULES


async def fallen_startup():
    LOGGER.info("[•] Loading Modules...")
    for module in ALL_MODULES:
        importlib.import_module("Mahmoudquran.Modules." + module)
...
if __name__ == "__main__":
    asyncio.get_event_loop().run_until_complete(mahmoud_startup())
    LOGGER.error("Mahmoudquran Bot Stopped.")