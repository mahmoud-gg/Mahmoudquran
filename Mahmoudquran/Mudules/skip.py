...
from Mahmoudquran import BOT_USERNAME, app, fallendb, pytgcalls
from Mahmoudquran.Helpers import _clear_, admin_check, buttons, close_key, gen_thumb
    ...
    if not get:
        try:
            ...
            await message.reply_text(
                text=f"⌔︙ الـتـالـي \n \n⌔︙ بواسطة : {message.from_user.mention} \n\n**⌔︙ لا يوجد سور** {message.chat.title}, ****",
